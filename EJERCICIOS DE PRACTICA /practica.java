...
public class practica {
    ...
    static void ejercicio4_4(Scanner sc) {
        ...
        if (num < 0)
            ...
            System.out.printf("La raíz cuadrada de %.4f es %.4f%n", num, Math.sqrt(num));
    }
    ...
    static void ejercicio4_5(Scanner sc) {
        ...
        if (num % 2 == 0)
            ...
            System.out.println("Impar (con %)");
        if ((num & 1) == 0)
            System.out.println("Par (con operador &)");
        else
            System.out.println("Impar (con operador &)");
    }
    ...
    static void ejercicio4_8(Scanner sc) {
        ...
        if (num2 != 0 && num1 % num2 == 0)
            ...
            System.out.println("Ambos son cero: indeterminado");
        else
            System.out.println("Ninguno es divisible entre el otro");
    }
    ...
    static void ejercicio4_9(Scanner sc) {
        ...
        if (ang > 0 && ang < 90)
            ...
            System.out.println("Ángulo fuera de rango (0-180)");
    }
static void ejercicio4_10(Scanner sc) {
    ...
    static void ejercicio4_11(Scanner sc) {
        System.out.print("Ingrese el primer número: ");
