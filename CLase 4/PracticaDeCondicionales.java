    ...
    public static void main (String[] args){
       ...
       double angulo = 80;
        ...
        /*ejercicio 4.1 B)  */
            ...
            if (temperatura > 100) { System.out.println("por encima del punto de ebullición del agua");
                
            }
            else { System.out.println("por debajo del punto de ebullición del agua");}


        /*ejercicio 4.1 C)  */

            int positivos = 0; int negativos = 0; int numero = 10;
         ...
         int x = 100; int y = 20; int z = 10;

         if (x > y && z < 20) {
         int P = x * y;
         System.out.println("La distancia P es: "+ P);
            
         } else { System.out.println("no es posible calcular distancia para P ");}
        ...
        else { System.out.println("no es posible calcular el tiempo ");}
